...
Jogo com uma História fortemente inspirada no filme Interstellar e com mecânicas  .....
***

## Mecânicas
- ### Colidir/empurrar
  - Poder puxar e empurrar certos objetos como pedras ou partes de nave, ect.
- ### Saltar  
  - Poder saltar por cima de objetos.
- ### Flutuar/Super Salto 
  - Numa parte do jogo poder dar saltos maiores devido à gravidade do planeta.
- ### Sprint 
  - Poder dar uma uma pequena corrida para saltar mais longe.
- ### Score
...
***
## Progressão
  A Progressão pelo jogo é feita ao completar os diferentes níveis e a progressão dentro de cada nível é singular, ou seja, cada nível tem as suas mecânicas e a sua história. 

  ### Planeta Terra
  - No planeta terra temos o jogador tem fazer certas acões para fazer a história avançar, na Nasa o jogador após falar com Dr.Brand terá acesso ás mecânicas base numa zona de teste. 
   
  ### Planeta das ondas
  - No planeta das ondas temos que seguir os eventos da história e a historia irá se adaptar á escolha que o jogador fizer, voltar para a nave rápidamente ou tentar aclançar o localizador da outra nave.
  
  ### Planeta Congelado
  - Neste planeta o jogador também tera de seguir os eventos da história, nos quais após de ser atirado para um vale pelo Dr.Mann, terá de saltar por plataformas enquanto se desvia de pedras para sair do vale e avisar o resto da equipa que Dr.Mann é um traidor. 
